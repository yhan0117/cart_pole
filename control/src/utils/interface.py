...
if __name__ == "__main__":
    ...
    #   - multithreading
    #   - GUI with RViz/ Gazebo
    #   - reset function in encoder.cpp to reset encoder counter based on read
    #   - pack parameters in namedtuple (change m1 m2 -> mc mp)
    #   - global optimization with eggholder in scipy https://docs.scipy.org/doc/scipy/tutorial/optimize.html#id42\
    #   - update setup.py
    ...
    zd = np.multiply(np.array(dict_['zr']), np.array([1, np.pi/180, 1, 1]))
